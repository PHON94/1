...
local GameList = {
	...
	["9073513091"] = { id = "4abb05ea54cda73a7bdbddb1a4269fc9", keyless = true },  -- Anime Apocalypse
...
local Library do
	...
	local function ValidateKey(Key)
		...
		if Result.code == "KEY_VALID" then
			...
			if not (
				GameId == "4658598196" -- Attack on Titan Revolution
					...
					or GameId == "3808223175" -- Jujutsu Infinite
					or GameId == "66654135" -- Murder Mystery 2
