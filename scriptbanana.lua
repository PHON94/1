...
--// 5. HÀM TẠO TAB & TOGGLE (TỰ ĐỘNG CO GIÃN CANVAS)
...
--=============================================================================
--         KHỞI TẠO NÚT BẤM (ĐẦY ĐỦ CẢ 2 TABS CHỨC NĂNG)
--=============================================================================

-- Tab 1: Trang Chủ (Chứa chức năng cày rương cũ)
...
-- Tab 2: Tộc V4 (Chứa chức năng đồ sát đi Trial mới tối ưu)
...
--=============================================================================
-- [CHỨC NĂNG CŨ] LOGIC QUÉT VÀ PHÂN LOẠI RƯƠNG TRÊN TOÀN MAP
--=============================================================================
...
--=============================================================================
--         [CHỨC NĂNG MỚI] XỬ LÝ FAST ATTACK ĐỒ SÁT QUA REMOTE AN TOÀN
--=============================================================================
task.spawn(function()
...
--=============================================================================
--       [CHỨC NĂNG CŨ] VÒNG LẶP CHÍNH CHẠY AUTO CHEST & AUTO HOP SERVER
--=============================================================================
task.spawn(function()
    while true do
        task.wait(0.5)
        -- Điều kiện: Chỉ chạy nhặt rương khi không bật Đồ sát người chơi để tránh xung đột Teleport
        if _G.AutoChest and not _G.AutoKillPlayers then
            ...
            if chestPart then
                ...
                -- Khi bản đồ hết rương, nếu bật Auto Hop thì tự tìm phòng mới
                if _G.AutoHop then
                    HopServer()
                end
            end
